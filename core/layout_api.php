...
function layout_footer() {
	...
	echo '<address>' . "\n";
	echo '<strong>Powered by MantisBT ' . $t_version_suffix . '</a></strong> <br>' . "\n";
	echo "<small>Copyright & 2022 TRPA GIS Team</small>" . '<br>';
	...
	if( !is_page_name( 'login_page' ) ) {
		...
		echo '<a href="https://gis.trpa.org/tracker" '.
			'title="TRPA Issue Tracker">' .
